...
$(function(){
	wColumns = [
	    ...
	    {title: "수요자ID", 	dataType: "string", dataIndx: "CON_LOGIN_ID", 	halign: "center", align: "left"},
	    {title: "수요자명", 	dataType: "string", dataIndx: "CON_NM", 		halign: "center", align: "left"},
	    {title: "창고ID", 	dataType: "string", dataIndx: "WH_ID", 			halign: "center", align: "center"},
	    {title: "창고명", 	dataType: "string", dataIndx: "WH_NM", 			halign: "center", align: "left"},
	    ...
	    {title: "공유층수", 	dataType: "string", dataIndx: "SH_FLR", 		halign: "center", align: "right"},
	...
	cColumns = [
	    ...
	    {title: "차량번호(FULL)", 	dataType: "string", dataIndx: "CAR_FULL_NO", 	halign: "center", align: "left"},
	    {title: "매칭일자", 		dataType: "string", dataIndx: "MAT_CON_DT",		halign: "center", align: "center"},
	    {title: "사용일자", 	 	dataType: "string", dataIndx: "SH_ST_DT",		halign: "center", align: "center"},
	...
	eColumns = [
	    ...
	    {title: "매칭일자", 	dataType: "string", dataIndx: "MAT_CON_DT",		halign: "center", align: "center"},
	    {title: "사용일자", 	dataType: "string", dataIndx: "SH_ST_DT",		halign: "center", align: "center"},
	    {title: "기자재명", 	dataType: "string", dataIndx: "EQUIP_NM",		halign: "center", align: "left"},
	...
	mColumns = [
	    ...
	    {title: "수요자ID", 	dataType: "string", dataIndx: "CON_LOGIN_ID", 	halign: "center", align: "left"},
	    {title: "수요자명", 	dataType: "string", dataIndx: "CON_NM", 		halign: "center", align: "left"},
	    {title: "인력ID", 	widtType: "string", dataIndx: "MANPW_NO", 		halign: "center", align: "center"},
	    {title: "성명", 		dataType: "string", dataIndx: "MANPW_NM", 		halign: "center", align: "left"},
	    {title: "매칭일자", 	dataType: "string", dataIndx: "MAT_CON_DT",		halign: "center", align: "center"},
	    {title: "사용일자", 	dataType: "string", dataIndx: "SH_ST_DT",		halign: "center", align: "center"},
...
function init(){
	nowColumns = wColumns;
	nowGridId = "sup_match_pqgrid_div_W";
	changeGrid("W");
...
function changeGrid(matCd){
	nowGridId = "sup_match_pqgrid_div_" + matCd;
	$(".sup_match_pqgrid_div").hide();
	$("#" + nowGridId).show();
}
...
function save(){
	...
	if(confirm("[매칭종료] " + gMsg.kr.uc_02)){
		$.ajax({ 
			type: "POST",
			dataType: "json",
			url: "/rs/supMatch/matEnd",
			data: param,
			async: false,
