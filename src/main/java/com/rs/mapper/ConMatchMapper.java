...
@Mapper
public interface ConMatchMapper {

	// 수요자 아이디 조회
	public List<Map<String, Object>> getSupId(Map<String, Object> map);
	
	// 수요자 이름 조회
	public List<Map<String, Object>> getSupNm(Map<String, Object> map);
