...
import com.dc.mapper.DcSafesensorMapper;
import com.fasterxml.jackson.databind.ObjectMapper;

@Service
@Transactional
public class DcSafesensorService {

	@Autowired
	private DcSafesensorMapper dcSafesensorMapper;
	
	public Map<String, Object> selectSafesensorList(Map<String, Object> param) {
		Map<String, Object> data = new HashMap<String, Object>();
		try {
			List<Map<String, Object>> dataList = dcSafesensorMapper.selectSafesensorList(param);
	...
	public Map<String, Object> saveSafesensor(Map<String, Object> param) {
		Map<String, Object> data = new HashMap<String, Object>();
		try {
			...
			for (Map<String, Object> map : addList) {
				...
				dcSafesensorMapper.createSafesensor(map);
			}
	
			for (Map<String, Object> map : updateList) {
				map.put("userId", userId);
				dcSafesensorMapper.updateSafesensor(map);
			}
	
			for (Map<String, Object> map : deleteList) {
				dcSafesensorMapper.deleteSafesensor(map);
			}
		} catch (Exception e) {
