...
@RestController
public class DcArimaOpenController {
    @PostMapping("/open/stockBarChart")
    public String stockBarChart() throws IOException, CsvException {
    	InputStream stream = getClass().getResourceAsStream("/static/csv/vinbstOpen.csv");
    ...
    @PostMapping("/open/deliveryBarChart")
    public String deliveryBarChart() throws IOException, CsvException {
    	InputStream stream = getClass().getResourceAsStream("/static/csv/voubstOpen.csv");
    	InputStreamReader streamReader = new InputStreamReader(stream, StandardCharsets.UTF_8);
