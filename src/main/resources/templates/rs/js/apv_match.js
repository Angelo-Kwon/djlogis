...
$(function() {
	wColumns = [
	    ...
	    {title: "수요자ID", 	dataType: "string", dataIndx: "CON_LOGIN_ID", 	halign: "center", align: "center"},
	    {title: "수요자명", 	dataType: "string", dataIndx: "CON_NM", 		halign: "center", align: "center"},
	    ...
	    {title: "매칭요청일자", dataType: "string", dataIndx: "MAT_REQ_DT",		halign: "center", align: "center"},
	...
	mColumns = [
	    ...
	    {title: "매칭요청일자", dataType: "string", dataIndx: "MAT_REQ_DT",		halign: "center", align: "center"},
	    {title: "인력업체", 	dataType: "string", dataIndx: "CP_CD_NM",		halign: "center", align: "left"},
...
// 저장(매칭승인)
function save(){
	var dataList = gGrid.Checkbox('checked').getCheckedNodes();
	...
	if(confirm("[승인] " + gMsg.kr.uc_02)){
		$.ajax({ 
			type: "POST",
			dataType: "json",
			url: "/rs/apvMatch/matApv",
			data: param,
			async: false,
			success: function(data){
				if(data.error){
